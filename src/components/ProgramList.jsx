    ...
    <div className="bg-gradient-to-r from-blue-50 to-indigo-50 min-h-screen">
      ...
      <div className="relative w-full h-96">
        ...
        <div className="absolute inset-0 bg-black bg-opacity-60 flex items-center justify-center">
          <h1 className="text-white text-4xl md:text-6xl lg:text-7xl font-bold tracking-wider text-center">
      ...
      {/* <div className="bg-gradient-to-r from-purple-500 to-indigo-600 py-16">
        <div className="max-w-2xl mx-auto text-center px-4">
          ...
          <form className="space-y-4">
            <input 
              type="email" 
              className="w-full p-3 rounded-full focus:outline-none focus:ring-2 focus:ring-indigo-300" 
